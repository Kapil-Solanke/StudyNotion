...
const About = () => {
  return (
    <div>
      ...
      <section className="border-b mt-20 max-sm:mt-10  border-richblack-700">
      ...
      <StatsComponenet />
      <section className="mx-auto max-sm:w-full max-sm:p-2 mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white">
        <LearningGrid />
        <ContactFormSection />
      </section>
